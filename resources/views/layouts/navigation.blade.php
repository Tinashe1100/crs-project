<nav x-data="{ open: false }"
    ...
    <div :class="{ 'tw-block': open, 'tw-hidden': !open }" class="tw-hidden sm:tw-hidden">
        ...
        <div class="tw-pt-4 pb-1 tw-border-t tw-border-gray-200 dark:tw-border-gray-600">
            <div class="px-4">
