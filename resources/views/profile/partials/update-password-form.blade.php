<section>
    <header>
        ...
        <p class="tw-mt-1 tw-text-sm tw-text-gray-600 dark:tw-ext-gray-400">
    ...
    <form method="post" action="{{ route('password.update') }}" class="tw-mt-6 tw-space-y-6">
        ...
        <div>
            <x-input-label for="update_password_current_password" :value="__('Current Password')" class="tw-text-gray-400" />
        ...
        <div>
            <x-input-label for="update_password_password" :value="__('New Password')" class="tw-text-gray-400" />
        ...
        <div>
            <x-input-label for="update_password_password_confirmation" :value="__('Confirm Password')" class="tw-text-gray-400" />
        ...
        <div class="tw-flex items-center gap-4">
            <x-primary-button
                class="tw-bg-gray-500 tw-font-medium tw-px-5 tw-py-2 tw-rounded-md">{{ __('Save') }}</x-primary-button>
